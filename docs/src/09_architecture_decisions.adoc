...
** **Monolithic arquitecture:** where all game logic, API web and data storage services would be integrated in a single backend app. 
...
* **Status:** Accepted by the teacher and development team.
* **Possible alternatives:**
** There were no possible alternatives because this was an imposed contraint, given by the course's teachers.
